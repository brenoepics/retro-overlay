...
import com.overlay.plugin.commands.CmdCommand;
import com.overlay.plugin.commands.EventAlertCommand;
import com.overlay.plugin.commands.YoutubeCommand;
import com.overlay.plugin.communication.outgoing.audio.DisposePlaylistComposer;
...
import com.overlay.plugin.communication.outgoing.audio.PlaylistComposer;
import com.overlay.plugin.communication.outgoing.common.SessionDataComposer;
import com.overlay.plugin.communication.outgoing.common.UpdateCreditsComposer;
import com.overlay.plugin.interactions.InteractionSlotMachine;
import com.overlay.plugin.interactions.InteractionYoutubeJukebox;
import com.overlay.plugin.override_packets.incoming.JavascriptCallbackEvent;
import com.overlay.plugin.override_packets.outgoing.JavascriptCallbackComposer;
import com.overlay.plugin.utils.DatabaseRegister;
...
public class main extends HabboPlugin implements EventListener {
    ...
    public void onEmulatorLoadedEvent(EmulatorLoadedEvent e) throws Exception {
        ...
        DatabaseRegister.databaseRegister();

        // register commands
        CommandHandler.addCommand(new YoutubeCommand());
        CommandHandler.addCommand(new EventAlertCommand("cmd_neweventalert", Emulator.getTexts().getValue("commands.keys.cmd_neweventalert").split(";")));
